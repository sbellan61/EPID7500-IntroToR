...
author: "Steve Bellan (slides altered from John Muschelli)"
output:
...
1.  **Data type problems (is that a string, number, or factor?)**
...
For now, let's ignore the [1]. We'll return back to why R prints this in front of each object it prints later on.
...
Learn to read R's Errors and Warnings. They will help you debug code.
...
[EPID 7500 Course Website](bellanlab.uga.edu/index.php/epid-7500/)

John Muschelli's [Course](http://johnmuschelli.com/intro_to_r/) at Johns Hopkins & [github repository](https://github.com/muschellij2/intro_to_r)
